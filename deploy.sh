...
arm-linux-gnueabihf-strip target/arm-unknown-linux-gnueabihf/release/plato-smart-device-client
...
HOOK_DIR="$KOBO_MOUNTPOINT/.adds/plato/bin/plato-smart-device-client/"
mkdir -p "$HOOK_DIR"

echo "Copying..."
cp target/arm-unknown-linux-gnueabihf/release/plato-smart-device-client "$HOOK_DIR"
